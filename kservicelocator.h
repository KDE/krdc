...
class KServiceLocator : public QObject {
 ...
 public:
	 ...
	 * is necessary even when you parsed an attribute list.
	 ...
	 * query because then even the necessary paranthesis characters
	 * will be escaped.
	 ...
	 * It is not guaranteed that you do not receive any signals after
